...
void Textbook::display(){
  ...
  std::cout << getTitle() << " is written by " << getAuthor() << " for " << getGradeLevel() << " students. Subject: " << subject_ << ". " << review << " review questions. Page Count: " << getPageCount() << ". " << digital << " available digitally.\n";
}
